...
class Plugin {
	...
	public static function Settings(GenericEvent $event) {
		...
		$settings->add_text_setting('apisettings', 'litespeed_username', 'Litespeed Username:', 'Litespeed Username', $settings->get_setting('FANTASTICO_USERNAME'));
		$settings->add_text_setting('apisettings', 'litespeed_password', 'Litespeed Password:', 'Litespeed Password', $settings->get_setting('FANTASTICO_PASSWORD'));
		$settings->add_dropdown_setting('stock', 'outofstock_licenses_litespeed', 'Out Of Stock Litespeed Licenses', 'Enable/Disable Sales Of This Type', $settings->get_setting('OUTOFSTOCK_LICENSES_FANTASTICO'), array('0', '1'), array('No', 'Yes', ));
	}
